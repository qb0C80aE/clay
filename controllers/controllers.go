...
func processSingleGetText(c *gin.Context, model interface{}, actualLogic func(*gorm.DB, string, string) (string, error)) {
	ver, err := version.New(c)
...
func processMultiGetText(c *gin.Context, model interface{}, actualLogic func(*gorm.DB, string) (string, error)) {
	ver, err := version.New(c)
